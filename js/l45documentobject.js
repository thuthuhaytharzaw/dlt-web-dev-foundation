...
// document.getElementById("tasktitle").innerHTML = '<span styel="color:blue">My Jobs</span>'
...
getul.children[1].innerHTML = `Have to read <a href="#" id="delete-item3" class="delete-me delete-item">
